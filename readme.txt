...
* Changed: optimized loading of css/js files. If you are using the Yes-co example theme, please update it to the [latest version](http://www.yes-co.nl/downloads/yesco_ores_theme_1.5.1.zip "latest version") before updating the plugin!
= 1.3.31 =
